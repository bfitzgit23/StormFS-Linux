...
- [ ] **ROADMAP / POST-GRUB IMPLEMENTATION:** Add a separately maintained BFSOS LTS kernel flavor after the current GRUB/bootloader generation path is stable and regression-tested.
